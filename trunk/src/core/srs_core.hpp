...
#define RTMP_SIG_SRS_UPSTREAM_VERSION SRS_XSTR(VERSION_MAJOR) "." SRS_XSTR(VERSION_MINOR) "." SRS_XSTR(VERSION_REVISION)
#define RTMP_SIG_SRS_FORK_REVISION 11
#define RTMP_SIG_SRS_FORK_VERSION RTMP_SIG_SRS_UPSTREAM_VERSION "-itb." SRS_XSTR(RTMP_SIG_SRS_FORK_REVISION)
#define RTMP_SIG_SRS_VERSION RTMP_SIG_SRS_FORK_VERSION
